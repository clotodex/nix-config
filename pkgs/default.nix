...
[
  ...
  (_final: prev: {
    ...
    voxtype = inputs.voxtype.packages.${pkgs.stdenv.hostPlatform.system}.default; # prev.callPackage ../pkgs/ashell.nix { inherit inputs; };
    figma-agent-build = prev.callPackage ../pkgs/figma-agent.nix { inherit inputs; };
    # voxtype = prev.callPackage ../pkgs/voxtype.nix { inherit inputs; };
